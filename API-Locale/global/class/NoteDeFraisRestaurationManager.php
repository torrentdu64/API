...
class NoteDeFraisRestaurationManager extends Manager {
  ...
  public function read($IdNoteDeFraisRestauration) {
      $this->pdoStatement = $this->pdo->prepare("SELECT * FROM notedefrais_restauration WHERE IdNoteDeFraisRestauration = :IdNoteDeFraisRestauration");
      $this->pdoStatement->bindValue(':IdNoteDeFraisRestauration', $IdNoteDeFraisRestauration, PDO::PARAM_INT);
  ...
  public function create(NoteDeFrais $noteDeFraisRestauration) {
    ...
    $this->pdoStatement = $this->pdo->prepare("UPDATE notedefrais_restauration SET IntituleNDF = :IntituleNDF, DateNDF = :DateNDF, MotifNDF = :MotifNDF, MontantPrevu = :MontantPrevu , EtatNDF = :EtatNDF , Commentaire = :Commentaire, NbreRepasSiRestauration = :NbreRepasSiRestauration,Login = :Login,IdClient = :IdClient WHERE IdNoteDeFraisRestauration = :IdNoteDeFraisRestauration");
    $this->pdoStatement->bindValue(':IdNoteDeFraisRestauration',$noteDeFraisRestauration->getIdNoteDeFraisRestauration(), PDO::PARAM_INT);
    $this->pdoStatement->bindValue(':IntituleNDF', $noteDeFraisRestauration->getIntituleNDF(), PDO::PARAM_STR);
    $this->pdoStatement->bindValue(':DateNDF', $noteDeFraisRestauration->getDateNDF(), PDO::PARAM_STR);
    $this->pdoStatement->bindValue(':MotifNDF', $noteDeFraisRestauration->getMotifNDF(), PDO::PARAM_STR);
  ...
  public function delete($IdNoteDeFraisRestauration) {
    $this->pdoStatement = $this->pdo->prepare("DELETE FROM notedefrais_restauration WHERE IdNoteDeFraisRestauration = $IdNoteDeFraisRestauration");
    $this->pdoStatement->execute();
